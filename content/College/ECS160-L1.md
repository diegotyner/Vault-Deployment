...
### HW assignments
- Apache Cassandra persistence layer using Java annotation and reflection
- Social media data analysis using Spring Boot micro-services and Kafka
- Deployment of microservices on Google Cloud and Kubernetes
- (Tentative) Fuzz testing a provided library with custom mutators
